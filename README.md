...
- Logic: Logic reduces to *if, then, goto* (along with mathematical symbols). Define and layer packets of logic. Give commands synonyms so the AI you're essentially configuring has better intuition and needs less rigorously worded input.
